...
class LotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lot" do
    assert_difference('Lot.count') do
      post lots_url, params: { lot: { address: @lot.address, lot: @lot.lot, permit: @lot.permit, phase: @lot.phase, plan_type_id: @lot.plan_type_id, project_id: @lot.project_id } }
    end
  ...
  test "should update lot" do
    patch lot_url(@lot), params: { lot: { address: @lot.address, lot: @lot.lot, permit: @lot.permit, phase: @lot.phase, plan_type_id: @lot.plan_type_id, project_id: @lot.project_id } }
